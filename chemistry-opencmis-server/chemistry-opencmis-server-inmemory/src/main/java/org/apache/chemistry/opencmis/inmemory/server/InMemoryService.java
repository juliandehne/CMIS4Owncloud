...
public class InMemoryService extends AbstractCmisService {
	...
	public void addObjectToFolder(String repositoryId, String objectId,
		...
		fMultiSvc.addObjectToFolder(getCallContext(), repositoryId, objectId,
				folderId, allVersions, extension, this);
	}
	...
	public void appendContentStream(String repositoryId,
		...
		fObjSvc.appendContentStream(getCallContext(), repositoryId, objectId,
	...
	public Acl applyAcl(String repositoryId, String objectId, Acl addAces,
			...
			ExtensionsData extension) {
		return fAclSvc.applyAcl(getCallContext(), repositoryId, objectId,
				addAces, removeAces, aclPropagation, extension, this);
	}
	...
	public Acl applyAcl(String repositoryId, String objectId, Acl aces,
		...
		return fAclSvc.applyAcl(getCallContext(), repositoryId, objectId, aces,
				aclPropagation);
	}
	...
	public void applyPolicy(String repositoryId, String policyId,
		...
		fPolSvc.applyPolicy(getCallContext(), repositoryId, policyId, objectId,
				extension);
	}
	...
	public List<BulkUpdateObjectIdAndChangeToken> bulkUpdateProperties(
		...
		return fObjSvc.bulkUpdateProperties(getCallContext(), repositoryId,
				...
				removeSecondaryTypeIds, extension, this);
	}

	@Override
	public void cancelCheckOut(String repositoryId, String objectId,
			ExtensionsData extension) {
		fVerSvc.cancelCheckOut(getCallContext(), repositoryId, objectId,
				extension);
	}
	...
	public String create(String repositoryId, Properties properties,
			...
			ExtensionsData extension) {
		String id = fObjSvc.create(getCallContext(), repositoryId, properties,
	...
	public String createDocument(String repositoryId, Properties properties,
		...
		return fObjSvc.createDocument(getCallContext(), repositoryId,
	...
	public String createDocumentFromSource(String repositoryId,
			...
			VersioningState versioningState, List<String> policies,
			Acl addAces, Acl removeAces, ExtensionsData extension) {
		return fObjSvc.createDocumentFromSource(getCallContext(), repositoryId,
	...
	public String createFolder(String repositoryId, Properties properties,
		...
		// return fObjSvc.createFolder(getCallContext(), repositoryId,
	...
	public String createItem(String repositoryId, Properties properties,
			String folderId, List<String> policies, Acl addAces,
			Acl removeAces, ExtensionsData extension) {
		return fObjSvc.createItem(getCallContext(), repositoryId, properties,
	...
	public String createPolicy(String repositoryId, Properties properties,
			String folderId, List<String> policies, Acl addAces,
			Acl removeAces, ExtensionsData extension) {
		return fObjSvc.createPolicy(getCallContext(), repositoryId, properties,
				folderId, policies, addAces, removeAces, extension);
	}
	...
	public String createRelationship(String repositoryId,
			...
			Acl removeAces, ExtensionsData extension) {
		return fObjSvc.createRelationship(getCallContext(), repositoryId,
	...
	public TypeDefinition createType(String repositoryId, TypeDefinition type,
			ExtensionsData extension) {
		return fRepSvc.createType(getCallContext(), repositoryId, type,
				extension);
	}
	...
	public void deleteContentStream(String repositoryId,
			Holder<String> objectId, Holder<String> changeToken,
			ExtensionsData extension) {
		fObjSvc.deleteContentStream(getCallContext(), repositoryId, objectId,
	...
	public void deleteObject(String repositoryId, String objectId,
		...
		fObjSvc.deleteObject(getCallContext(), repositoryId, objectId,
	...
	public FailedToDeleteData deleteTree(String repositoryId, String folderId,
		...
		return fObjSvc.deleteTree(getCallContext(), repositoryId, folderId,
	...
	public Acl getAcl(String repositoryId, String objectId,
		...
		return fAclSvc.getAcl(getCallContext(), repositoryId, objectId,
				onlyBasicPermissions, extension, this);
	}

	@Override
	public AllowableActions getAllowableActions(String repositoryId,
			String objectId, ExtensionsData extension) {
		return fObjSvc.getAllowableActions(getCallContext(), repositoryId,
				objectId, extension);
	}
	...
	public List<ObjectData> getAllVersions(String repositoryId,
		...
		return fVerSvc.getAllVersions(getCallContext(), repositoryId, objectId,
	...
	public List<ObjectData> getAppliedPolicies(String repositoryId,
		...
		return fPolSvc.getAppliedPolicies(getCallContext(), repositoryId,
	...
	public ObjectList getCheckedOutDocs(String repositoryId, String folderId,
		...
		return fNavSvc.getCheckedOutDocs(getCallContext(), repositoryId,
	...
	public ObjectInFolderList getChildren(String repositoryId, String folderId,
		...
		return fNavSvc.getChildren(getCallContext(), repositoryId, folderId,
	...
	public ObjectList getContentChanges(String repositoryId,
		...
		return fDisSvc.getContentChanges(getCallContext(), repositoryId,
	...
	public ContentStream getContentStream(String repositoryId, String objectId,
			...
			ExtensionsData extension) {
		return fObjSvc.getContentStream(getCallContext(), repositoryId,
	...
	public List<ObjectInFolderContainer> getDescendants(String repositoryId,
		...
		return fNavSvc.getDescendants(getCallContext(), repositoryId, folderId,
				depth, filter, includeAllowableActions, includeRelationships,
				renditionFilter, includePathSegment, extension, this);
	}

	@Override
	public ObjectData getFolderParent(String repositoryId, String folderId,
			String filter, ExtensionsData extension) {
		return fNavSvc.getFolderParent(getCallContext(), repositoryId,
				folderId, filter, extension, this);
	}
	...
	public List<ObjectInFolderContainer> getFolderTree(String repositoryId,
			...
			IncludeRelationships includeRelationships, String renditionFilter,
			Boolean includePathSegment, ExtensionsData extension) {
		return fNavSvc.getFolderTree(getCallContext(), repositoryId, folderId,
				depth, filter, includeAllowableActions, includeRelationships,
				renditionFilter, includePathSegment, extension, this);
	}
	...
	public ObjectData getObject(String repositoryId, String objectId,
			...
			ExtensionsData extension) {
		return fObjSvc.getObject(getCallContext(), repositoryId, objectId,
	...
	public ObjectData getObjectByPath(String repositoryId, String path,
		...
		return fObjSvc.getObjectByPath(getCallContext(), repositoryId, path,
				filter, includeAllowableActions, includeRelationships,
				renditionFilter, includePolicyIds, includeAcl, extension, this);
	}
	...
	public ObjectData getObjectOfLatestVersion(String repositoryId,
			...
			Boolean includePolicyIds, Boolean includeAcl,
			ExtensionsData extension) {
		return fVerSvc.getObjectOfLatestVersion(getCallContext(), repositoryId,
				objectId, versionSeriesId, major, filter,
				includeAllowableActions, includeRelationships, renditionFilter,
				includePolicyIds, includeAcl, extension, this);
	}
	...
	public List<ObjectParentData> getObjectParents(String repositoryId,
		...
		return fNavSvc.getObjectParents(getCallContext(), repositoryId,
				objectId, filter, includeAllowableActions,
				includeRelationships, renditionFilter,
				includeRelativePathSegment, extension, this);
	}
	...
	public ObjectList getObjectRelationships(String repositoryId,
			...
			String filter, Boolean includeAllowableActions,
			BigInteger maxItems, BigInteger skipCount, ExtensionsData extension) {
		return fRelSvc.getObjectRelationships(getCallContext(), repositoryId,
	...
	public Properties getProperties(String repositoryId, String objectId,
			String filter, ExtensionsData extension) {
		return fObjSvc.getProperties(getCallContext(), repositoryId, objectId,
				filter, extension);
	}
	...
	public Properties getPropertiesOfLatestVersion(String repositoryId,
			String objectId, String versionSeriesId, Boolean major,
			String filter, ExtensionsData extension) {
		return fVerSvc.getPropertiesOfLatestVersion(getCallContext(),
				repositoryId, objectId, versionSeriesId, major, filter,
				extension);
	}
	...
	public List<RenditionData> getRenditions(String repositoryId,
			...
			BigInteger skipCount, ExtensionsData extension) {
		return fObjSvc.getRenditions(getCallContext(), repositoryId, objectId,
	...
	public RepositoryInfo getRepositoryInfo(String repositoryId,
			ExtensionsData extension) {
		return fRepSvc.getRepositoryInfo(getCallContext(), repositoryId,
				extension);
	}
	...
	public TypeDefinitionList getTypeChildren(String repositoryId,
			...
			BigInteger maxItems, BigInteger skipCount, ExtensionsData extension) {
		return fRepSvc.getTypeChildren(getCallContext(), repositoryId, typeId,
	...
	public void moveObject(String repositoryId, Holder<String> objectId,
			...
			ExtensionsData extension) {
		fObjSvc.moveObject(getCallContext(), repositoryId, objectId,
				targetFolderId, sourceFolderId, extension, this);
	}
	...
	public ObjectList query(String repositoryId, String statement,
			...
			IncludeRelationships includeRelationships, String renditionFilter,
			BigInteger maxItems, BigInteger skipCount, ExtensionsData extension) {
		return fDisSvc.query(getCallContext(), repositoryId, statement,
	...
	public void removeObjectFromFolder(String repositoryId, String objectId,
		...
		fMultiSvc.removeObjectFromFolder(getCallContext(), repositoryId,
				objectId, folderId, extension, this);
	}

	@Override
	public void removePolicy(String repositoryId, String policyId,
			String objectId, ExtensionsData extension) {
		fPolSvc.removePolicy(getCallContext(), repositoryId, policyId,
				objectId, extension);
	}
	...
	public void setContentStream(String repositoryId, Holder<String> objectId,
		...
		fObjSvc.setContentStream(getCallContext(), repositoryId, objectId,
	...
	public void updateProperties(String repositoryId, Holder<String> objectId,
			...
			ExtensionsData extension) {
		fObjSvc.updateProperties(getCallContext(), repositoryId, objectId,
				changeToken, properties, null, extension, this);
	}

	@Override
	public TypeDefinition updateType(String repositoryId, TypeDefinition type,
			ExtensionsData extension) {
		return fRepSvc.updateType(getCallContext(), repositoryId, type,
				extension);
	}
