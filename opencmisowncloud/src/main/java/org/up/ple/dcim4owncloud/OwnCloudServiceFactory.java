...
import org.apache.chemistry.opencmis.server.impl.CallContextImpl;
	...
	public class OwnCloudServiceFactory extends AbstractServiceFactory {
	    ...
	    private static final Logger LOG = LoggerFactory.getLogger(OwnCloudServiceFactory.class);
	        ...
	        for (String key : keys) {
	            if (key.startsWith(PREFIX_LOGIN)) {
	                ...
	                if (key.endsWith(SUFFIX_READWRITE)) {
	                    // read-write users
	                    OwnCloudFileShareRepository fsr = repositoryManager.getRepository(repositoryId);
	                    ...
	                    OwnCloudFileShareRepository fsr = new OwnCloudFileShareRepository(repositoryId, root, typeManager);
